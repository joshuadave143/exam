	...
	<div class="se-pre-con"></div> 
        ...
        <div class="content">
            ...
            <form class="login-form" action="<?=base_url()?>/admin/auth" method="post" accept-charset="utf-8">
                <div>
                    <img src="<?=base_url()?>/assets/img/logo.webp" alt="logo" class="img-responsive" width="100"
        ...
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright">
        2021 &copy; NETSECPH <br> Developed by <a href="https://www.facebook.com/jeepny.ako/" style="color: #ff5f5f;">Joshua Dave F Tonido</a>.
        </div>
        <!-- END COPYRIGHT -->
