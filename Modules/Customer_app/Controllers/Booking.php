<?php
	...
	class Booking extends \Modules\Common\Controllers\CustomerBaseController
	{
		use ResponseTrait;
	    ...
	    public function index(){
			...
			array_push($this->data['js_entries'],
				...
				array('js_link' => base_url().'/assets/scripts/booking.js')
	        );
			...
			$this->data['page']         = 'Modules\Customer_app\Views\Booking';
	        $this->data['css_custom']   = "";
	        $this->data['js_custom']    = "";


	        $side['side_bar'] = $this->load_sidebar(array('item_index' => 1, 'sub_index' => 0, 'page_title' => 'Dashboard', 'show_page_title' => 1, 'show_breadcrumbs' => 1, 'user_type' => 0));
