    ...
    jQuery.fn.extend({
        slimScroll: function(i) {
            ...
            return this.each(function() {
                ...
                function s() {
                    window.addEventListener ? (this.addEventListener("DOMMouseScroll", o, { capture: false, passive: false }), this.addEventListener("mousewheel", o, { capture: false, passive: false })) : document.attachEvent("onmousewheel", o)
                }
